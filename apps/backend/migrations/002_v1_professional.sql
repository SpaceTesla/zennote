...
-- 
-- Local testing:
--   wrangler d1 execute zennote-d1 --local --file=./migrations/002_v1_professional.sql
-- 
...
-- 
-- ============================================================================
-- MIGRATION FROM 001_init_production.sql
-- ============================================================================
-- 
-- ⚠️ WARNING: This is a breaking change from the previous schema
-- 
-- Key differences:
-- 1. REMOVED: user_notes table (redundant)
-- 2. REMOVED: user_socials table (can add later)
-- 3. CHANGED: notes table structure (visibility, ownership_type, slug)
-- 4. ADDED: user_settings, note_views, note_deletions, audit_logs
-- 
-- To migrate existing data, you'll need to:
-- 1. Export existing notes
-- 2. Transform data to new schema
-- 3. Import into new tables
-- 
-- Contact: Your migration script will be needed here
-- 
-- ============================================================================
